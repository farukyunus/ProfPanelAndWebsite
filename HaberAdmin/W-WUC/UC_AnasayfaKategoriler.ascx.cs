    ...
    public partial class UC_AnasayfaKategoriler : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    AnasayfaKategoriHaberleri AKH = new AnasayfaKategoriHaberleri//SQL kayıtları içinde dönerken listenin içini dolduruyorum, .add diyerek yine aynı tipteki listenin içine ekliyorum kayıtları.
                    {
